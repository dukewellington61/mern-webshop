        ...
        <div className="column">
          <div className="text_wrapper">
            ...
            <p>
              ...
              the Online Dispute Resolution Platform (OS Platform). Consumers
              have the possibility to submit complaints to the Online Dispute
              Resolution Platform of the European Commission at
              http://ec.europa.eu/odr?tid=321230892. You will find the necessary
              contact details above in our legal notice. However, we would like
              to point out that we are not willing or obliged to participate in
        ...
        <div className="column">
          <div className="text_wrapper">
            ...
            <p>
              ...
              information according to the general laws due to court or official
              orders remain unaffected even in case of our non-responsibility
              according to §§ 8 to 10. Should you notice problematic or illegal
              content, please contact us immediately so that we can remove the
              illegal content. You can find the contact details in the legal
              notice.
            </p>
            <br />
