...
const LineItem = ({ line_item, cart }) => {
  return (
    <div id="line_item_row" className="row">
      ...
      <div id="product_page_info_container" className="col-xl">
        <Link to={`/products/${line_item.product_id}`}>
          <b>{line_item.name}</b>
        </Link>
      ...
      <div id="product_page_quantity_field_container" className="col-xl">
        <QuantityField
      ...
      <div id="product_page_subtotal_container" className="col-xl">
